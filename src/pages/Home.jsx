      ...
      <main className="main">
          ...
          <div className="home__container  grid">
            <div className="home__data">
              ...
              <p className="home__description">
                MediLink is a secure blockchain based platform for storage of
        ...
        <section className="contact section container" id="contact">
            <div className="contact__container grid">
                ...
                <ul className="contact__content grid">
                    <li className="contact__address">Telephone: <span className="contact__information">+91 977777777</span>
                    </li>
                    <li className="contact__address">Email: <span
                            className="contact__information">yatish.medilink@gmail.com</span></li>
                    <li className="contact__address">Location: <span className="contact__information">AP Shah Institute of Technology 
                            , Maharashtra, Thane, Kasarwadavli 401107</span></li>
                </ul>
                <iframe
        ...
        <footer className="footer section">
          <p className="footer__copy">
            Design And Developed By Yatish , Atharva , Yuvraj and Yash
          </p>
          <p className="footer__copy">&#169; MediLink. All right reserved</p>
        </footer>
    </div>
  );
};
